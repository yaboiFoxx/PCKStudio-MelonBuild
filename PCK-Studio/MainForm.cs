...
namespace PckStudio
{
	public partial class MainForm : MetroFramework.Forms.MetroForm
	{
		...
		{
			RPC.Initialize();
			RPC.SetPresence("Melon Build Revamp of PCK Studio", "Revamp by A4L");
		...
		private void LoadEditorTab()
		{
			...
			if (TryGetLocFile(out LOCFile locfile) && locfile.HasLocEntry("IDS_DISPLAY_NAME"))
				RPC.SetPresence($"Editing a Pack: {locfile.GetLocEntry("IDS_DISPLAY_NAME", "en-EN")}", "Melon Build by A4L");
		}
        ...
        private void ChangelogRichTextBox_TextChanged(object sender, EventArgs e)
        {
